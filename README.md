...
Check your terminal — a local link (like http://localhost:5173/) will appear. Open it to view your portfolio.
...
The optimized build will appear inside the `dist` folder. You can deploy this folder to any hosting provider like Netlify, Vercel, or Firebase Hosting.
...
3. Go to Project Settings → Your Apps → Firebase SDK snippet, and copy the config.
4. Paste it inside your project’s `firebase.js` and `firebase-comment.js`.
5. Set up Firestore collections as per your app needs.
...
Contributions, issues, and suggestions are welcome — open a GitHub issue or a PR. Thank you!
...
> > > > > > > 66032024cd456ac96b787f360fcf1ccef2289221
