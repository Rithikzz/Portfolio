        ...
        >
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              {/* Social Icons */}
              <motion.div
                className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8 md:mb-12"
                variants={childVariants}
              >
                <div data-aos="fade-down" data-aos-delay="200">
                  <IconButton Icon={Github} link="https://github.com/Rithikzz" />
                </div>
                <div data-aos="fade-down" data-aos-delay="400">
                  <IconButton Icon={User} link="https://linkedin.com/in/rithik-s-056804363" />
                </div>
                <div data-aos="fade-down" data-aos-delay="600">
                  <IconButton Icon={Globe} link="https://instagram.com/_rithik_.s" />
                </div>
              </motion.div>
              ...
              >
                <a
                  href="https://github.com/Rithikzz"
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="Network & Telecom Student | Tech Enthusiast" />
                    </span>
                  </div>
                </a>
              </motion.div>
